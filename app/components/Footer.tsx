      ...
      <div className="w-full md:w-[80%] h-[100%]">
        <div className="flex flex-col md:flex-row md:justify-between justify-center items-center mb-4">
          ...
          <div className="flex flex-col gap-1 text-center md:text-start">
            ...
            <Link href="/products">
              <span className="text-lg md:text-sm ">Nosotros</span>
            </Link>
            <Link href="/login">
              <span className="text-lg md:text-sm ">Servicios</span>
            </Link>
            <span className="text-lg md:text-sm ">Trabajos</span>
            <span className="text-lg md:text-sm ">Planes</span>
          </div>
